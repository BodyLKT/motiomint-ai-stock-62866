        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              or CapCut ("Third-Party Services"). These services are operated by independent providers, not by MotioMint.
            </p>
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              ...
              <li>MotioMint does not claim any partnership, sponsorship, or endorsement by Canva, CapCut, or any other Third-Party Service mentioned on the site.</li>
            </ul>
